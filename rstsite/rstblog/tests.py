...
:translation_of: Start something'''
    ...
    ## how change article dir?
    #def test_reset_article_table(self):
    ...
    #    
    #    path = reverse(
    #        'rstblog:reset_article_table',
    #        kwargs=dict(),
    #        )
    #    dir = Path(settings.RSTBLOG['ARTICLES_DIR'])
    #    response = c.get(path, follow=True, dir = dir)
    #    self.assertEqual(response.status_code, 200)
